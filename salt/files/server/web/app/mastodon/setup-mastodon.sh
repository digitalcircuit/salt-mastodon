...
git checkout $(git tag -l |{% if salt['pillar.get']('server:web:app:mastodon:use_unstable_versions', False) == False %} grep -v 'rc[0-9]*$' | grep -v 'beta[0-9]*$' |{% endif %} sort -V | tail -n 1)
